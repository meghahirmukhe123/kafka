...
public class userBillServiceImpl implements billService {
	...
	@Override
	public List<userBill> getAllUserBill() {// TODO Auto-generated method stub
		return repo.findAll();
	}

	@Override
	public String deleteBillByEmailID(String emailId) {
		
		return repo.deleteByemailId(emailId);
	}
